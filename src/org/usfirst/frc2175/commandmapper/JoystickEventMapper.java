...
import org.usfirst.frc2175.command.single.ShiftToClimbGearCommand_Low;
...
public class JoystickEventMapper {
    ...
    public JoystickEventMapper(RobotConfig robotConfig,
        ...
        testAction.whenPressed(new TurnToHeadingCommand(robotSubsystems,
        ...
        climbshift.toggleWhenPressed(
                new ShiftToClimbGearCommand_Low(robotSubsystems));
