...
public class TwoBallChevalDeFriseShootSlightRightAutonomous
        extends CommandGroup {
    public TwoBallChevalDeFriseShootSlightRightAutonomous(
        ...
        addSequential(new CrossChevalDeFriseAndShootSlightRightAutonomous(
