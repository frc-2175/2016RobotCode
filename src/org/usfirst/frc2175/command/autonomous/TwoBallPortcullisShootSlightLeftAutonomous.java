...
public class TwoBallPortcullisShootSlightLeftAutonomous extends CommandGroup {
    public TwoBallPortcullisShootSlightLeftAutonomous(
        ...
        addSequential(new CrossPortcullisAndShootSlightLeftAutonomous(
