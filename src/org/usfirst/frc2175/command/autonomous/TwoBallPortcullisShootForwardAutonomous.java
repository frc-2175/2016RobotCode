...
public class TwoBallPortcullisShootForwardAutonomous extends CommandGroup {
    public TwoBallPortcullisShootForwardAutonomous(
        ...
        addSequential(new CrossPortcullisAndShootForwardAutonomous(
