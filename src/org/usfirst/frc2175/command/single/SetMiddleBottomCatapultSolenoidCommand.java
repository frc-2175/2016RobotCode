 ...
 *
 */
public class SetMiddleBottomCatapultSolenoidCommand extends Command {
    private final CatapultShooterSubsystem catapultShooterSubsystem;
    private boolean isOn;

    public SetMiddleBottomCatapultSolenoidCommand(
            RobotSubsystems robotSubsystems, boolean isOn) {
    ...
    protected void initialize() {
        catapultShooterSubsystem.setMiddleBottomSolenoid(isOn);
    }
