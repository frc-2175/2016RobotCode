 ...
 *
 */
public class RaiseClimberCommand extends BaseCommand {
    private ClimberSubsystem climberSubsystem;
    private final Logger log = Logger.getLogger(getClass().getName());

    public RaiseClimberCommand(RobotSubsystems robotSubsystems) {
    ...
    protected void initialize() {
        super.initialize();
        climberSubsystem.setClimberPosition(true);
