...
public class JMockitTest {
    ...
    public void testIt() {
        ...
        Point constructorArg = sut.getConstructorArg();
        Point instanceVariable = sut.getInstanceVariable();
        ActiveEvent activeEvent2 = sut.getActiveEvent();
