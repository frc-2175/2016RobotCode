...
public class MotionProfilerTest extends TestBase {
    private final MotionProfiler sut = new MotionProfiler();
    private final String testCSVName = "testProfile.csv";

    @Test
    public void testParseMotionProfileFromCSV_goodDTime() {
        sut.setProfileLocationToUse(MotionProfiler.PROFILE_CSV_TEST_LOCATION);
        int dTime = 50;
        MotionProfile profile;
        profile = sut.parseMotionProfileFromCSV(testCSVName, dTime);
    ...
    public void testParseMotionProfileFromCSV_badDTime() {
        sut.setProfileLocationToUse(MotionProfiler.PROFILE_CSV_TEST_LOCATION);
        int dTime = 40;
        MotionProfile profile;
        profile = sut.parseMotionProfileFromCSV(testCSVName, dTime);
